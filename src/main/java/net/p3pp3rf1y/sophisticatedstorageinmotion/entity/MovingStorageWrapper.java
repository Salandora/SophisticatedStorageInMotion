...
public class MovingStorageWrapper implements IStorageWrapper {
	...
	public int getNumberOfInventorySlots() {
		Integer numberOfInventorySlots = storageStack.sophisticatedLibrary_get(ModCoreDataComponents.NUMBER_OF_INVENTORY_SLOTS);
	...
	public int getNumberOfUpgradeSlots() {
		@Nullable Integer numberOfUpgradeSlots = storageStack.sophisticatedLibrary_get(ModCoreDataComponents.NUMBER_OF_UPGRADE_SLOTS);
	...
	public Optional<UUID> getContentsUuid() {
		return Optional.ofNullable(storageStack.sophisticatedLibrary_get(ModCoreDataComponents.STORAGE_UUID));
	}
	...
	public Optional<Integer> getOpenTabId() {
		return Optional.ofNullable(storageStack.sophisticatedLibrary_get(ModCoreDataComponents.OPEN_TAB_ID));
	}

	@Override
	public void setOpenTabId(int openTabId) {
		storageStack.sophisticatedLibrary_set(ModCoreDataComponents.OPEN_TAB_ID, openTabId);
		stackChangeHandler.run();
	}

	@Override
	public void removeOpenTabId() {
		storageStack.sophisticatedLibrary_remove(ModCoreDataComponents.OPEN_TAB_ID);
		stackChangeHandler.run();
	}
	...
	public void setSortBy(SortBy sortBy) {
		storageStack.sophisticatedLibrary_set(ModCoreDataComponents.SORT_BY, sortBy);
		stackChangeHandler.run();
	}

	@Override
	public SortBy getSortBy() {
		return storageStack.sophisticatedLibrary_getOrDefault(ModCoreDataComponents.SORT_BY, SortBy.NAME);
	}
	...
	private class MovingStorageRenderInfo extends RenderInfo {
		...
		protected void serializeRenderInfo(CompoundTag renderInfo) {
			MovingStorageWrapper.this.storageStack.sophisticatedLibrary_set(ModCoreDataComponents.RENDER_INFO_TAG, CustomData.of(renderInfo));
		}

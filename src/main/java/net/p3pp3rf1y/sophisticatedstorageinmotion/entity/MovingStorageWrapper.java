...
public class MovingStorageWrapper implements IStorageWrapper {
	...
	public int getNumberOfInventorySlots() {
		Integer numberOfInventorySlots = storageStack.sophisticatedFabricLibrary_get(ModCoreDataComponents.NUMBER_OF_INVENTORY_SLOTS);
	...
	public int getNumberOfUpgradeSlots() {
		@Nullable Integer numberOfUpgradeSlots = storageStack.sophisticatedFabricLibrary_get(ModCoreDataComponents.NUMBER_OF_UPGRADE_SLOTS);
	...
	public Optional<UUID> getContentsUuid() {
		return Optional.ofNullable(storageStack.sophisticatedFabricLibrary_get(ModCoreDataComponents.STORAGE_UUID));
	}
	...
	public Optional<Integer> getOpenTabId() {
		return Optional.ofNullable(storageStack.sophisticatedFabricLibrary_get(ModCoreDataComponents.OPEN_TAB_ID));
	}

	@Override
	public void setOpenTabId(int openTabId) {
		storageStack.sophisticatedFabricLibrary_set(ModCoreDataComponents.OPEN_TAB_ID, openTabId);
		stackChangeHandler.run();
	}

	@Override
	public void removeOpenTabId() {
		storageStack.sophisticatedFabricLibrary_remove(ModCoreDataComponents.OPEN_TAB_ID);
		stackChangeHandler.run();
	}
	...
	public void setSortBy(SortBy sortBy) {
		storageStack.sophisticatedFabricLibrary_set(ModCoreDataComponents.SORT_BY, sortBy);
		stackChangeHandler.run();
	}

	@Override
	public SortBy getSortBy() {
		return storageStack.sophisticatedFabricLibrary_getOrDefault(ModCoreDataComponents.SORT_BY, SortBy.NAME);
	}
	...
	private class MovingStorageRenderInfo extends RenderInfo {
		...
		protected void serializeRenderInfo(CompoundTag renderInfo) {
			MovingStorageWrapper.this.storageStack.sophisticatedFabricLibrary_set(ModCoreDataComponents.RENDER_INFO_TAG, CustomData.of(renderInfo));
		}
